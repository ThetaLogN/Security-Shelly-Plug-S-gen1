 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.20.0/apps/shelly-plug-s/esp8266/build_contexts/build_ctx_509497058/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.20.0/apps/shelly-plug-s/esp8266/build_contexts/build_ctx_509497058/build/gen/mos_conf_schema.yml
 */
...
static const struct mgos_conf_entry mgos_config_schema_[] = {
    {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 226},
    ...
    {.type = CONF_TYPE_STRING, .key = "udp_ip", .offset = offsetof(struct mgos_config, app.udp_ip)},
    {.type = CONF_TYPE_INT, .key = "udp_port", .offset = offsetof(struct mgos_config, app.udp_port)},
};
...
void mgos_config_mqtt_set_defaults(struct mgos_config_mqtt *cfg) {
  cfg->enable = true;
  cfg->server = "74.161.73.178:1883";
  cfg->client_id = "shellyplug-s-DC43B6";
  cfg->user = NULL;
  cfg->pass = NULL;
...
const struct mgos_conf_entry *mgos_config_board_btn3_get_schema(void) {
  return &mgos_config_schema_[221];
}
...
const char * mgos_config_get_default_mqtt_server(void) { return "74.161.73.178:1883"; }
...
const char * mgos_config_get_default_mqtt_client_id(void) { return "shellyplug-s-DC43B6"; }
...
const char * mgos_config_get_default_mqtt1_client_id(void) { return "shellyplug-s-DC43B6"; }
...
const char * mgos_config_get_default_wifi_ap_ssid(void) { return "ShellyPlugS-Setup"; }
...
/* app.udp_ip */
const char * mgos_config_get_app_udp_ip(const struct mgos_config *cfg) { return cfg->app.udp_ip; }
const char * mgos_config_get_default_app_udp_ip(void) { return "74.161.73.178"; }
void mgos_config_set_app_udp_ip(struct mgos_config *cfg, const char * v) { mgos_conf_set_str(&cfg->app.udp_ip, v); }

/* app.udp_port */
int mgos_config_get_app_udp_port(const struct mgos_config *cfg) { return cfg->app.udp_port; }
int mgos_config_get_default_app_udp_port(void) { return 9999; }
void mgos_config_set_app_udp_port(struct mgos_config *cfg, int v) { cfg->app.udp_port = v; }
