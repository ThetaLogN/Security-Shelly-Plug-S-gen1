...
/* app.udp_ip */
#define MGOS_CONFIG_HAVE_APP_UDP_IP
#define MGOS_SYS_CONFIG_HAVE_APP_UDP_IP
const char * mgos_config_get_app_udp_ip(const struct mgos_config *cfg);
const char * mgos_config_get_default_app_udp_ip(void);
static inline const char * mgos_sys_config_get_app_udp_ip(void) { return mgos_config_get_app_udp_ip(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_app_udp_ip(void) { return mgos_config_get_default_app_udp_ip(); }
void mgos_config_set_app_udp_ip(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_app_udp_ip(const char * v) { mgos_config_set_app_udp_ip(&mgos_sys_config, v); }

/* app.udp_port */
#define MGOS_CONFIG_HAVE_APP_UDP_PORT
#define MGOS_SYS_CONFIG_HAVE_APP_UDP_PORT
int mgos_config_get_app_udp_port(const struct mgos_config *cfg);
int mgos_config_get_default_app_udp_port(void);
static inline int mgos_sys_config_get_app_udp_port(void) { return mgos_config_get_app_udp_port(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_udp_port(void) { return mgos_config_get_default_app_udp_port(); }
void mgos_config_set_app_udp_port(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_udp_port(int v) { mgos_config_set_app_udp_port(&mgos_sys_config, v); }
