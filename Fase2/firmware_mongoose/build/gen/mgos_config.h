 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.20.0/apps/firmware_mongoose/esp8266/build_contexts/build_ctx_080732118/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.20.0/apps/firmware_mongoose/esp8266/build_contexts/build_ctx_080732118/build/gen/mos_conf_schema.yml
 */
...
/* update.enabled */
#define MGOS_CONFIG_HAVE_UPDATE_ENABLED
#define MGOS_SYS_CONFIG_HAVE_UPDATE_ENABLED
int mgos_config_get_update_enabled(const struct mgos_config *cfg);
int mgos_config_get_default_update_enabled(void);
static inline int mgos_sys_config_get_update_enabled(void) { return mgos_config_get_update_enabled(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_update_enabled(void) { return mgos_config_get_default_update_enabled(); }
void mgos_config_set_update_enabled(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_update_enabled(int v) { mgos_config_set_update_enabled(&mgos_sys_config, v); }

/* update.version */
#define MGOS_CONFIG_HAVE_UPDATE_VERSION
#define MGOS_SYS_CONFIG_HAVE_UPDATE_VERSION
const char * mgos_config_get_update_version(const struct mgos_config *cfg);
const char * mgos_config_get_default_update_version(void);
static inline const char * mgos_sys_config_get_update_version(void) { return mgos_config_get_update_version(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_update_version(void) { return mgos_config_get_default_update_version(); }
void mgos_config_set_update_version(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_update_version(const char * v) { mgos_config_set_update_version(&mgos_sys_config, v); }
...
/* app.relay_pin */
#define MGOS_CONFIG_HAVE_APP_RELAY_PIN
#define MGOS_SYS_CONFIG_HAVE_APP_RELAY_PIN
int mgos_config_get_app_relay_pin(const struct mgos_config *cfg);
int mgos_config_get_default_app_relay_pin(void);
static inline int mgos_sys_config_get_app_relay_pin(void) { return mgos_config_get_app_relay_pin(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_relay_pin(void) { return mgos_config_get_default_app_relay_pin(); }
void mgos_config_set_app_relay_pin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_relay_pin(int v) { mgos_config_set_app_relay_pin(&mgos_sys_config, v); }

/* app.btn_pin */
#define MGOS_CONFIG_HAVE_APP_BTN_PIN
#define MGOS_SYS_CONFIG_HAVE_APP_BTN_PIN
int mgos_config_get_app_btn_pin(const struct mgos_config *cfg);
int mgos_config_get_default_app_btn_pin(void);
static inline int mgos_sys_config_get_app_btn_pin(void) { return mgos_config_get_app_btn_pin(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_btn_pin(void) { return mgos_config_get_default_app_btn_pin(); }
void mgos_config_set_app_btn_pin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_btn_pin(int v) { mgos_config_set_app_btn_pin(&mgos_sys_config, v); }

/* app.led_green_pin */
#define MGOS_CONFIG_HAVE_APP_LED_GREEN_PIN
#define MGOS_SYS_CONFIG_HAVE_APP_LED_GREEN_PIN
int mgos_config_get_app_led_green_pin(const struct mgos_config *cfg);
int mgos_config_get_default_app_led_green_pin(void);
static inline int mgos_sys_config_get_app_led_green_pin(void) { return mgos_config_get_app_led_green_pin(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_led_green_pin(void) { return mgos_config_get_default_app_led_green_pin(); }
void mgos_config_set_app_led_green_pin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_led_green_pin(int v) { mgos_config_set_app_led_green_pin(&mgos_sys_config, v); }

/* app.led_red_pin */
#define MGOS_CONFIG_HAVE_APP_LED_RED_PIN
#define MGOS_SYS_CONFIG_HAVE_APP_LED_RED_PIN
int mgos_config_get_app_led_red_pin(const struct mgos_config *cfg);
int mgos_config_get_default_app_led_red_pin(void);
static inline int mgos_sys_config_get_app_led_red_pin(void) { return mgos_config_get_app_led_red_pin(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_led_red_pin(void) { return mgos_config_get_default_app_led_red_pin(); }
void mgos_config_set_app_led_red_pin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_led_red_pin(int v) { mgos_config_set_app_led_red_pin(&mgos_sys_config, v); }

/* app.mqtt_topic_base */
#define MGOS_CONFIG_HAVE_APP_MQTT_TOPIC_BASE
#define MGOS_SYS_CONFIG_HAVE_APP_MQTT_TOPIC_BASE
const char * mgos_config_get_app_mqtt_topic_base(const struct mgos_config *cfg);
const char * mgos_config_get_default_app_mqtt_topic_base(void);
static inline const char * mgos_sys_config_get_app_mqtt_topic_base(void) { return mgos_config_get_app_mqtt_topic_base(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_app_mqtt_topic_base(void) { return mgos_config_get_default_app_mqtt_topic_base(); }
void mgos_config_set_app_mqtt_topic_base(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_app_mqtt_topic_base(const char * v) { mgos_config_set_app_mqtt_topic_base(&mgos_sys_config, v); }
