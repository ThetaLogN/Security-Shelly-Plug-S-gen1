...
static const struct mgos_conf_entry mgos_config_schema_[] = {
    {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 230},
    ...
    {.type = CONF_TYPE_OBJECT, .key = "update", .offset = offsetof(struct mgos_config, update), .num_desc = 19},
    ...
    {.type = CONF_TYPE_BOOL, .key = "enabled", .offset = offsetof(struct mgos_config, update.enabled)},
    {.type = CONF_TYPE_STRING, .key = "version", .offset = offsetof(struct mgos_config, update.version)},
    ...
    {.type = CONF_TYPE_OBJECT, .key = "wifi", .offset = offsetof(struct mgos_config, wifi), .num_desc = 76},
    ...
    {.type = CONF_TYPE_INT, .key = "relay_pin", .offset = offsetof(struct mgos_config, app.relay_pin)},
    {.type = CONF_TYPE_INT, .key = "btn_pin", .offset = offsetof(struct mgos_config, app.btn_pin)},
    {.type = CONF_TYPE_INT, .key = "led_green_pin", .offset = offsetof(struct mgos_config, app.led_green_pin)},
    {.type = CONF_TYPE_INT, .key = "led_red_pin", .offset = offsetof(struct mgos_config, app.led_red_pin)},
    {.type = CONF_TYPE_STRING, .key = "mqtt_topic_base", .offset = offsetof(struct mgos_config, app.mqtt_topic_base)},
};
...
void mgos_config_app_set_defaults(struct mgos_config_app *cfg) {
  ...
  cfg->led_green_pin = 0;
  cfg->led_red_pin = 2;
  cfg->mqtt_topic_base = "shellies/plug-s";
}
...
const char * mgos_config_get_default_mqtt_server(void) { return NULL; }
...
int mgos_config_get_default_update_interval(void) { return 3600; }
...
/* update.enabled */
int mgos_config_get_update_enabled(const struct mgos_config *cfg) { return cfg->update.enabled; }
int mgos_config_get_default_update_enabled(void) { return true; }
void mgos_config_set_update_enabled(struct mgos_config *cfg, int v) { cfg->update.enabled = v; }

/* update.version */
const char * mgos_config_get_update_version(const struct mgos_config *cfg) { return cfg->update.version; }
const char * mgos_config_get_default_update_version(void) { return "1.0.0"; }
void mgos_config_set_update_version(struct mgos_config *cfg, const char * v) { mgos_conf_set_str(&cfg->update.version, v); }
...
/* app.relay_pin */
int mgos_config_get_app_relay_pin(const struct mgos_config *cfg) { return cfg->app.relay_pin; }
int mgos_config_get_default_app_relay_pin(void) { return 15; }
void mgos_config_set_app_relay_pin(struct mgos_config *cfg, int v) { cfg->app.relay_pin = v; }

/* app.btn_pin */
int mgos_config_get_app_btn_pin(const struct mgos_config *cfg) { return cfg->app.btn_pin; }
int mgos_config_get_default_app_btn_pin(void) { return 13; }
void mgos_config_set_app_btn_pin(struct mgos_config *cfg, int v) { cfg->app.btn_pin = v; }

/* app.led_green_pin */
int mgos_config_get_app_led_green_pin(const struct mgos_config *cfg) { return cfg->app.led_green_pin; }
int mgos_config_get_default_app_led_green_pin(void) { return 0; }
void mgos_config_set_app_led_green_pin(struct mgos_config *cfg, int v) { cfg->app.led_green_pin = v; }

/* app.led_red_pin */
int mgos_config_get_app_led_red_pin(const struct mgos_config *cfg) { return cfg->app.led_red_pin; }
int mgos_config_get_default_app_led_red_pin(void) { return 2; }
void mgos_config_set_app_led_red_pin(struct mgos_config *cfg, int v) { cfg->app.led_red_pin = v; }

/* app.mqtt_topic_base */
const char * mgos_config_get_app_mqtt_topic_base(const struct mgos_config *cfg) { return cfg->app.mqtt_topic_base; }
const char * mgos_config_get_default_app_mqtt_topic_base(void) { return "shellies/plug-s"; }
void mgos_config_set_app_mqtt_topic_base(struct mgos_config *cfg, const char * v) { mgos_conf_set_str(&cfg->app.mqtt_topic_base, v); }
