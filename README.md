...
- **Attività:** 
  ...
  - Esfiltrazione dei dati verso un server esterno (es. via UDP).
...
## ⚠️ Disclaimer
*Questo progetto è stato sviluppato a scopo puramente didattico, accademico e di ricerca nell'ambito della sicurezza informatica (Ethical Hacking). Non utilizzare i software o le tecniche descritte su dispositivi e reti per cui non si dispone di esplicita autorizzazione.*
